...
This is the C# version. We Also have a [VB.NET version](https://github.com/AtalaSupport/DemoGallery_Desktop_AdvancedDocCleanDemo_VB_x64) available.
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_AdvancedDocCleanDemo_CS_x64.git AdvancedDocCleanDemo --recursive
