...
This is the C# version. We Also have a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_AdvancedDocCleanDemo_VB_x64) available.
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_AdvancedDocCleanDemo_CS_x64.git AdvancedDocCleanDemo --recursive
