...
namespace AtalaDemos.AboutBox
{
    ...
    "ge.  This is a good starting place for learning about the SDK.";
            ...
            this.downloadHelpLinkLabel.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.apiRefLinkLabel_LinkClicked);
            // 
            // button1
            // 
            ...
            this.demoGalleryLinkLabel.Text = "AdvancedDocClean Demo Home";
            ...
            this.label4.Text = "Support / Sales Questions?  +1 949 236-6510";
            // 
            // pictureBox1
            // 
		...
		private void apiRefLinkLabel_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
		...
		{
            System.Diagnostics.Process.Start("https://www.atalasoft.com/KB2/KB/50086/FAQ-Where-Have-All-The-Demos-Gone");
		}
